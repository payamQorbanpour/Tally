...
const fa: PrivacyPolicyDoc = {
  ...
  intro: [
    "یلات برنامه‌ای برای ثبت و تقسیم هزینه‌های مشترک میان دوستان است. در این متن دقیقاً توضیح داده‌ایم که برنامه چه اطلاعاتی از شما دریافت می‌کند، چرا آن‌ها را دریافت می‌کند، چه کسانی آن‌ها را پردازش می‌کنند و ما متعهد می‌شویم که هرگز چه کارهایی با آن‌ها نکنیم.",
  ...
  sections: [
    {
      ...
      body: [
        "یلات تنها همان چیزی را دریافت می‌کند که یک قابلیت مشخص واقعاً به آن نیاز دارد. هیچ‌کدام از موارد زیر دریافت نمی‌شود مگر آنکه شما از قابلیت مربوط به آن استفاده کنید.",
      ],
      bullets: [
    ...
    },
    {
      ...
      body: [
        "یلات شمارهٔ تلفن همراه، کد ملی، تاریخ تولد، نشانی محل سکونت یا پستی، اطلاعات کارت و حساب بانکی، موقعیت مکانی دقیق، دفترچهٔ تماس، پیامک‌ها و سابقهٔ تماس شما را نه درخواست می‌کند و نه دریافت می‌کند. هیچ بخشی از برنامه این اطلاعات را نمی‌خواهد.",
    ...
    },
    {
      ...
      body: [
        "ما از اطلاعات شما برای پروفایل‌سازی رفتاری یا هدف‌گیری تبلیغاتی استفاده نمی‌کنیم. یلات تبلیغات پاداش‌دار اختیاری نشان می‌دهد — برای توضیح دقیق اینکه این کار شامل چه مواردی می‌شود و چه مواردی نمی‌شود، بخش «تبلیغات» را در پایین ببینید.",
      ],
    },
    {
    ...
    },
    {
      heading: "تبلیغات",
      body: [
        "یلات تبلیغات پاداش‌دار اختیاری‌ای را نمایش می‌دهد که شما می‌توانید در ازای دریافت اعتبار هوش مصنوعی آن‌ها را تماشا کنید. هیچ تبلیغی به‌طور خودکار پخش نمی‌شود و رد کردن تبلیغ هرگز هیچ قابلیتی را مسدود نمی‌کند.",
      ...
      bullets: [
        ...
        "استفادهٔ بدون تبلیغ از هوش مصنوعی به‌عنوان بخشی از پاس‌های یلات برنامه‌ریزی شده اما هنوز فعال نیست — فعلاً تبلیغات پاداش‌دار برای همه کاملاً اختیاری است و رد کردن آن‌ها فقط یعنی اعتبار هوش مصنوعی اضافه دریافت نمی‌کنید.",
      ],
    },
    {
    ...
    },
    {
      heading: "کودکان",
      body: [
        "یلات برای کودکان زیر ۱۳ سال طراحی نشده است و ما آگاهانه اطلاعاتی از آنان دریافت نمی‌کنیم.",
      ],
    },
    {

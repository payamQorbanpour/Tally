  ...
  sections: [
    {
      ...
      body: [
        "Tally تنها همان چیزی را دریافت می‌کند که یک قابلیت مشخص واقعاً به آن نیاز دارد. هیچ‌کدام از موارد زیر دریافت نمی‌شود مگر آنکه شما از قابلیت مربوط به آن استفاده کنید.",
      ],
      bullets: [
    ...
    },
    {
      ...
      body: [
        "Tally شمارهٔ تلفن همراه، کد ملی، تاریخ تولد، نشانی محل سکونت یا پستی، اطلاعات کارت و حساب بانکی، موقعیت مکانی دقیق، دفترچهٔ تماس، پیامک‌ها و سابقهٔ تماس شما را نه درخواست می‌کند و نه دریافت می‌کند. هیچ بخشی از برنامه این اطلاعات را نمی‌خواهد.",
    ...
    },
    {
      heading: "کودکان",
      body: [
        "Tally برای کودکان زیر ۱۳ سال طراحی نشده است و ما آگاهانه اطلاعاتی از آنان دریافت نمی‌کنیم.",
      ],
    },
    {

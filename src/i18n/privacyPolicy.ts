  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "برای پروانهداشت خریدی که انجام داده‌اید و باز نگه‌داشتن قابلیت‌های ویژه.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "استفادهٔ بدون تبلیغ از هوش مصنوعی به‌عنوان بخشی از پروانه‌های تالی برنامه‌ریزی شده اما هنوز فعال نیست — فعلاً تبلیغات پاداش‌دار برای همه کاملاً اختیاری است و رد کردن آن‌ها فقط یعنی اعتبار هوش مصنوعی اضافه دریافت نمی‌کنید.",
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        SUPPORT_EMAIL
          ? `اگر دربارهٔ این سیاست یا اطلاعاتتان پرسشی دارید، به نشانی ${SUPPORT_EMAIL} ایمیل بزنید تا پروانهخ دهیم.`
          : "اگر دربارهٔ این سیاست یا اطلاعاتتان پرسشی دارید، از مسیر تنظیمات ← راهنما و پشتیبانی در خود برنامه برای ما پیام بفرستید تا پروانهخ دهیم.",
      ],
    },
  ],
};

...
def create_icon(filename, config):
    ...
    logo = Image.open('/Users/payam/projects/github.com/payamqorbanpour/Tally/assets/Logo.jpg')
...
def main():
    print("Generating Tally icons from Logo.jpg with typography...")
